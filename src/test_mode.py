...
class TestMode:
    ...
    def show_menu(self):
        ...
        start_btn.bind("<Enter>", lambda e: start_btn.configure(bg=self.app.colors['primary']))
        start_btn.bind("<Leave>", lambda e: start_btn.configure(bg=self.app.colors['success']))
